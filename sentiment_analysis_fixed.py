...
def get_market_sentiment(symbol: str, analyzer: Optional[SentimentAnalyzer] = None) -> Dict[str, Any]:
    ...
    Returns:
        dict: نتایج تحلیل احساسات برای ارز مورد نظر
    """
    try:
        if analyzer is None:
        ...
        # ترکیب نتایج
        overall_score = (social_sentiment['sentiment_score'] * 0.5 + 
...
def get_fear_greed_index() -> Dict[str, Any]:
    ...
    Returns:
        dict: اطلاعات شاخص ترس و طمع
    """
    # ایجاد آنالیزگر و فراخوانی متد داخلی
    analyzer = SentimentAnalyzer()
    return analyzer.get_fear_greed_index()

def generate_sentiment_signal(sentiment_data: Dict[str, Any]) -> str:
    """
